...
Retain.new = function (callback)
{
  ...
  this._runPlugins("new", record, callback);
...
Retain.prototype.set = function(props, callback)
{
  ...
  this.constructor._runPlugins("set", this, callback);
...
Retain.find = function(props, callback)
{
  ...
  this._runPlugins("find", filter, callback);
...
{
  this._runPlugins("all", this._records, callback);
