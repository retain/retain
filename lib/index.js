...
* If a callback were suplied, and there is at least one plugin attached to the model, creates the record remotelly.
*
* @method new
* @static
...
*
* If a callback were suplied, and there is at least one plugin attached to the model, updates the record remotelly.
*
* @method set
...
*
* If a callback were suplied, and there is at least one plugin attached to the model, finds the record remotelly.
* @method find
* @static
...
Retain.find = function(id, callback)
{
  ...
  {
    if(this._records[i][this.id_prop] === id)
    {
...
*
* If a callback were suplied, and there is at least one plugin attached to the model, fetch the records remotelly.
* @method all
* @static
...
*
* If a callback were suplied, and there is at least one plugin attached to the model, removes the record remotelly.
* @method find
